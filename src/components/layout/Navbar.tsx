      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login" className="hidden sm:block font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors">
              Giriş Yap
            </Link>
            <Link href="/login" className="px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-full font-bold hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(6,182,212,0.4)] dark:shadow-[0_0_25px_rgba(6,182,212,0.6)] border border-white/20">
              Sisteme Başla
            </Link>
          </div>
        </div>
